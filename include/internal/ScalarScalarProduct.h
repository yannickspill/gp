...
struct traits<ScalarScalarProduct<Lhs, Rhs> > {
...
class ScalarScalarProduct
    : public ScalarBase<ScalarScalarProduct<Lhs, Rhs> > {
   private:
    Lhs lhs_;
    Rhs rhs_;

   public:
    typedef typename traits<ScalarScalarProduct<Lhs, Rhs> >::scalar_type
        scalar_type;
    typedef typename traits<ScalarScalarProduct<Lhs, Rhs> >::result_type
        result_type;
    typedef typename traits<ScalarScalarProduct<Lhs, Rhs> >::node_type
        node_type;

   public:
    // constructor
    ScalarScalarProduct(const Lhs& lhs, const Rhs& rhs)
        : lhs_(lhs), rhs_(rhs) {}
...
// operator*
template <class Lhs, class Rhs>
const ScalarScalarProduct<Lhs, Rhs> operator*(
    const ScalarBase<Lhs>& lhs, const ScalarBase<Rhs>& rhs) {
    return ScalarScalarProduct<Lhs, Rhs>(lhs.asDerived(),
                                            rhs.asDerived());
}
