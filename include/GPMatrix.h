...
class GPMatrixBase {
 ...
 //public:
  // typedefs
  typedef Derived::SomeType rd;
  typedef typename Derived::result_type rtype;
  static const unsigned RowsAtCompileTime = rtype::RowsAtCompileTime;
  static const unsigned ColsAtCompileTime = rtype::ColsAtCompileTime;
