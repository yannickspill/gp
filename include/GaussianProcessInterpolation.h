...
class GaussianProcessInterpolation
{
 public:
      ...
      */
  GaussianProcessInterpolation(MatrixXd x,
  ...
  double get_posterior_covariance(VectorXd x1,
                                  VectorXd x2) const;
 ...
 private:
  ...
  VectorXd get_wx_vector_second_derivative(VectorXd q, unsigned i, unsigned j)
      const;
