...
MatrixXd GaussianProcessInterpolation::get_d2cov_dwq_dOm(VectorXd q, unsigned m)
    const
{
    VectorXd wq(get_wx_vector(q));
...
MatrixXd GaussianProcessInterpolation::get_d2cov_dOm_dOm(VectorXd q,
